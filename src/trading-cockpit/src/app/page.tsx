...
import { BacktestView } from '../components/backtester/BacktestView';
...
export default function Dashboard() {
  ...
  return (
    <ChartThemeProvider>
      <BacktestProvider>
        <div className="flex flex-col h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-200 font-sans selection:bg-indigo-500/30 overflow-hidden">
          {/* GLOBAL UPDATE BANNER */}
          {hasUpdateAlert && activeView !== 'SYSTEM' && (
            <div
              className="bg-indigo-600 text-white px-4 py-2 flex items-center justify-between shadow-md shrink-0 z-50 animate-in slide-in-from-top-4 cursor-pointer hover:bg-indigo-700 transition-colors"
